...
module.exports = BaseTypes => {
  const warn = BaseTypes.ABSTRACT.warn.bind(undefined, 'https://www.postgresql.org/docs/current/static/datatype.html');
  ...
  function CIDR() {
    ...
    BaseTypes.CIDR.apply(this, arguments);
  }
  ...
  function INET() {
    ...
    BaseTypes.INET.apply(this, arguments);
  }
  inherits(INET, BaseTypes.INET);

  INET.parse = function parse(value) {
    return value;
  };
  ...
  function MACADDR() {
    ...
    BaseTypes.MACADDR.apply(this, arguments);
  }
  inherits(MACADDR, BaseTypes.MACADDR);

  MACADDR.parse = function parse(value) {
    return value;
  };
